...
Fig2B <- ggplot(juv,aes(x = dadage, y = TL)) +
          geom_point() +
          stat_smooth(method=lm) +
          xlab('Father age at hatching') +
          ylab('Offspring TL') +
          theme_lgs()
Fig2C <- ggplot(juv,aes(x = mumlife, y = TL)) +
          geom_point() +
...
Fig3A <- ggplot(juv,aes(x = TQ,y = SexEstimate)) +
...
Fig4A <- ggplot(juv,aes(x = mumlife,y = SexEstimate)) +
  geom_point(alpha=0.2) +
  stat_smooth(method = 'glm',family = 'binomial',se=T) +
...
Fig4B <- ggplot(juv,aes(x = dadlife,y = SexEstimate)) +
  geom_point(alpha=0.2) +
  stat_smooth(method = 'glm',family = 'binomial',se=T) +
...
Fig4C <- ggplot(juv,aes(x = mumage,y = SexEstimate)) +
  geom_point(alpha=0.2) +
  stat_smooth(method = 'glm',family = 'binomial',se=T) +
...
Fig4D <- ggplot(juv,aes(x = dadage,y = SexEstimate)) +
  geom_point(alpha=0.2) +
  stat_smooth(method = 'glm',family = 'binomial',se=T) +
