...
Fig3A <- ggplot(FL,aes(x = LmumTLKB, y = TLKB,col = Sex, fill = Sex, lty = Sex)) +
  geom_point() +
...
Fig3B <- ggplot(FL,aes(x = LdadTLKB, y = TLKB,col = Sex, fill = Sex, lty = Sex)) +
  geom_point() +
  stat_smooth(method=lm) +
  xlab('Paternal TL (kb)') +
  ylab('Offspring TL (kb)') +
...
Fig3C <- ggplot(FL,aes(x = parTL, y = TLKB,col = Sex, fill = Sex, lty = Sex)) +
  geom_point() +
  stat_smooth(method=lm) +
  xlab('Mean parental TL (kb)') +
  ylab('Offspring TL (kb)') +
...
Fig3D <- ggplot(FL,aes(x = TLKB, y = SurvivedNext,col = Sex, fill = Sex, lty = Sex)) +
  geom_point(alpha= 0.2) +
