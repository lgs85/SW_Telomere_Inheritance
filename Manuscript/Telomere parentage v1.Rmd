...
Komder *et al.* [-@Komdeur1997] found that Seychelles warblers modify the sex ratio of their offspring according to their territory quality. Here, by using telomeres, we show that this result is likely to be mediated by parental condition. Parents with longer telomeres produce more females and have offspring with longer telomeres. Additionally, we found that female, but not male, survival to adulthood is dependent on telomere length.

Using a much larger temporal dataset, we were unable to replicate the findings of Komdeur *et al.* [-@Komdeur1997] that females in high quality territories produce more females. This is because on Cousin Island average territory quality has increased, and variance in territory quality has decreased, dramatically over time due to conservation efforts. 
